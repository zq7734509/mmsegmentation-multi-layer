...
class DepthwiseSeparableASPPDnlHead(DepthwiseSeparableASPPHead):
    ...
    def __init__(self, c1_in_channels, c1_channels, reduction, use_scale, mode, **kwargs):
        super(DepthwiseSeparableASPPDnlHead, self).__init__(c1_in_channels, c1_channels, **kwargs)
    ...
    def forward(self, inputs):
        ...
        self.return_dnl = x     # 返回经过dnl处理的最后一个stage
